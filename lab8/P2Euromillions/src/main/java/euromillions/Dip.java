...
public class Dip {
    ...
    // Constants
    final static int MAX_NUMS = 5;
    final static int MAX_STARS = 2;
    final static int NUMS_BOUND = 49;
    final static int STARS_BOUND = 9;
    ...
    public Dip(int[] arrayOfNumbers, int[] arrayOfStarts) {
        ...
        if (MAX_NUMS == arrayOfNumbers.length && MAX_STARS == arrayOfStarts.length) {
    ...
    public static Dip generateRandomDip() {
        ...
        for (int i = 0; i < 5; ) {
            int candidate = generator.nextInt(NUMS_BOUND) + 1;
        ...
        for (int i = 0; i < 2; ) {
            int candidate = generator.nextInt(STARS_BOUND) + 1;
